...
| `--tag` | *(required)* | run token in the filename (`ohca_ohu_<tag>_<lo>_<hi>_dbar_<data>_tw<baseline>.nc`) and the `provenance_tag` attr. Used verbatim; should match the tag the blob was derived under. |
